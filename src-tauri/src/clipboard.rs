...
//!
//! # Capabilities: nothing was added, and here is why
//!
...
//! This module never crosses that frontier - it calls the plain Rust method on
//! the plugin's managed state - so no capability is involved, exactly as the
//! global shortcut in 1b needed none. Read from the plugin's source and
//! permission files; NOT yet confirmed by a run of the application.
